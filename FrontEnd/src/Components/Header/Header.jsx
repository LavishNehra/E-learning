...
const Header = ({ setFilter, showSearch = false }) => {
  ...
  const handleBackClick = () => {
    ...
    } else if (route.includes("/EditUnit")) {
      // For EditUnit, we need to get the courseId from state or navigate to courses
      // Since we don't have easy access to courseId from URL, go back in history
      navigate(-1);
